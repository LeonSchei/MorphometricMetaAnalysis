...
% use method of Schlax and Chelton, 1992; Greenslade et al. 1997
%
...
xmean = mean(x);
xsdev = std(x);
%idp = find(xsdev>0);JZ 20210602 commented should uncomment and find
%solution...
idp = find(xsdev>-0.1);%JZ 20210602 replacement previous
d=length(idp);
